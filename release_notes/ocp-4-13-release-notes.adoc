...
* Previously, the {product-title} documentation contained a "Expanding a cluster with on-premise bare metal nodes" sub section under the "Installing on AWS" section, because it was not accurate. The removal of this documentation is intended to avoid confusion.
