...
[NOTE]
====
Because {pipelines-title} releases on a different cadence from {OCP}, the {pipelines-title} documentation is now available as separate documentation sets for each minor version of the product.
