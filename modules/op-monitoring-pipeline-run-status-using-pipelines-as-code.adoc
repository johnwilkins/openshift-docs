...
When a pipeline run finishes, {pac} adds the status in the *Check* tabs with limited information on how long each task of your pipeline took, and the output of the `tkn pipelinerun describe` command.
