...
<2> This parameter is optional. Set this parameter to `true` to enable the additional controller or to `false` to disable the additional controller. The default value is `true`.
