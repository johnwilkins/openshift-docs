...
----
+
The <pipelinerun_id> in the above command is the ID for the `PipelineRun` that was returned in the output of the earlier command.
...
----
Note the output of the earlier command. You can access the application using this route.
