...
# ...
----
`pipelinesascode.tekton.dev/on-target-branch`:: You can specify multiple branches by adding comma-separated entries. For example, `"[main, release-nightly]"`. In addition, you can specify the following items:
