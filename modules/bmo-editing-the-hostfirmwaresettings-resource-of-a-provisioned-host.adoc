...
You can edit the `HostFirmwareSettings` for a provisioned host, delete the host from the machineset, scale down the machine set, and then scale up the machine set to make the changes take effect.
