...
|`sslcertdir` | Optional workspace that contains SSL/TLS certificates.
|===
...
|===
| Workspace | Description
|`source` | The workspace which can be used to mount files to send through the `curl` request to the Jenkins job.
|===
