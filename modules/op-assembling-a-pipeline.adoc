...
----
+
The pipeline definition abstracts away the specifics of the Git source repository and image registries. You add these details as `params` when you trigger and execute a pipeline.
