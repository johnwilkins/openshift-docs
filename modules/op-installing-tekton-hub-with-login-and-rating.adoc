...
<6> Optional: Additional users. You can mention multiple users, such as `[<username_1>, <username_2>, <username_3>]`.
...
[NOTE]
====
If you don't provide custom values for the optional fields in the `TektonHub` CR, the system uses the default values configured in the {tekton-hub} API config map.
====
