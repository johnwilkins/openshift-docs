...
As a cluster administrator, you can configure your GitHub App with the {OCP} cluster to use {pac}. This configuration allows you to run a set of tasks required for build deployment.
