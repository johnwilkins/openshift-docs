...
= Forwarding logs to Google Cloud Platform with service account keys

[role="_abstract"]
You can forward logs to link:https://cloud.google.com/logging/docs/basic-concepts[Google Cloud Logging] by using a Google service account key for authentication.
...
* xref:../configuring/cluster-logging-collector-log-forward-gcp-wif.adoc#cluster-logging-collector-log-forward-gcp-wif[Forwarding logs to Google Cloud Platform with Workload Identity Federation]
