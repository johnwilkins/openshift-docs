...
* link:https://mirror.openshift.com/pub/cgw/pipelines/1.20.3/tkn-linux-amd64.tar.gz[Linux (x86_64, amd64)]

* link:https://mirror.openshift.com/pub/cgw/pipelines/1.20.3/tkn-linux-s390x.tar.gz[Linux on {ibmzProductName} and {linuxoneProductName} (s390x)]

* link:https://mirror.openshift.com/pub/cgw/pipelines/1.20.3/tkn-linux-ppc64le.tar.gz[Linux on {ibmpowerProductName} (ppc64le)]

* link:https://mirror.openshift.com/pub/cgw/pipelines/1.20.3/tkn-linux-arm64.tar.gz[Linux on ARM (aarch64, arm64)]
