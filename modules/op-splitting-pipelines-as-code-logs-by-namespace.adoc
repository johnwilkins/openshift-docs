...
[source,terminal]
----
$ oc logs pipelines-as-code-controller-<unique_id> -n openshift-pipelines | grep mynamespace <1>
----
<1> Replace `pipelines-as-code-controller-<unique_id>` with the {pac} controller name.
